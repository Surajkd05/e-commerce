...
import classes from "./CustomerAddressUpdate.module.css";
...
const CustomerAddressUpdate = (props) => {
...
const mapDispatchToProps = (dispatch) => {
  return {
    onUpdateAddress: (addressData,addressId) =>
      dispatch(actions.onUpdateCustomerAddress(addressData,addressId)),
  };
};

export default connect(mapStateToProps,mapDispatchToProps)(CustomerAddressUpdate);
